...
import (
	...
	scheme "github.com/seveirbian/edgeserverless/pkg/client/clientset/versioned/scheme"
...
func newRoutes(c *EdgeserverlessV1alpha1Client, namespace string) *routes {
	return &routes{
		client: c.RESTClient(),
		ns:     namespace,
	}
