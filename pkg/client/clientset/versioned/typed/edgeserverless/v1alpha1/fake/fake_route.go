...
type FakeRoutes struct {
	Fake *FakeEdgeserverlessV1alpha1
	ns   string
}

var routesResource = schema.GroupVersionResource{Group: "edgeserverless.kubeedge.io", Version: "v1alpha1", Resource: "routes"}

var routesKind = schema.GroupVersionKind{Group: "edgeserverless.kubeedge.io", Version: "v1alpha1", Kind: "Route"}
